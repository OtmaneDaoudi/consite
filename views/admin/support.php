...
if(isset($_GET["id"])) //show support for a given demand
{
    ...
    $citizan = (new CitizanDao())->select(['id' => (new DemandDao())->select(["id" => $selectedDemand])[0]->getIdCitizan()])[0]; 
                ...
                <ul id="accordion-menu">
                    <li>
                        <a href="users.php" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-list-nested"></span><span class="mtext">Citizans</span>
                        </a>
                    </li>
                    <li>
                                        ...
                                        <?php if($selectedDemand != -1 ) :?> 
                                            <div class="clearfix">
                                                ...
                                                <div class="chat-profile-name">
                                                    <h3><?= $citizan->getFirstName()." ".$citizan->getLastName()?></h3>
                                                </div>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <div class="chat-desc customscroll">
                                        <ul>
                                            ...
                                            <?php foreach($discussion as $msg): ?>
                                                <li class="clearfix <?= ($msg->getSens() === 'CA') ? "admin_chat" : ""?>" style="height: 30px;">
                                                    <span class="chat-img">
                                                        <img src="../../public/images/photo1.jpg" alt="" />
                                                    </span>
